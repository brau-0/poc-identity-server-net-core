...
using TestIdentity.Api.Client.Models;
using TestIdentity.Api.Client.Services;

namespace TestIdentity.Api.Client.Controllers
{
    ...
    public class WeatherController : ControllerBase
    {
        ...
        public async Task<IEnumerable<WeatherForecast>> Get()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var result = await client.GetAsync("https://localhost:44361/weatherforecast");
